...
public class MyApplication extends Application {
    ...
    public static void send(final int requestCode, final int requestMethod,
                            final String url, final Map<String, String> params, final OnResponseListener listener){
        ...
        if(MyApplication.requestQueue != null){
            ...
            Log.d(TAG, "Request send : "+requestCode);
